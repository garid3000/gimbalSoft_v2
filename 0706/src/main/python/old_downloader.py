...
class downloader(object):
	...
	def download_1shot(self, each_image_id):
		tmp = 'http://spectrumcatcher.polarstarspace.com/veggie/report/view_report.php?id=mkuriki&v=103&c=02302092ef7b9187a41ff7947ebe50f6&fname=VeggieCamera_crops_spectrum_' # 20191213_140027_0.bmp'
		...
		urlname = 'http://spectrumcatcher.polarstarspace.com/veggie/results/mkuriki/' + each_image_id + "_crop.csv"
		...
		urlname = 'http://spectrumcatcher.polarstarspace.com/veggie/results/mkuriki/' + each_image_id + "_full.csv"
		print(self.directory[-2:],  tag, urlname)
		urllib.request.urlretrieve(urlname,  self.directory + "/" + tag  + '/' + each_image_id + 
		#                                '_' + Pitch    +
		#                                '_' + Roll     +
		...
		urlname = 'http://spectrumcatcher.polarstarspace.com/veggie/results/mkuriki/' + each_image_id + "_spec_NDVI.csv"
		print(self.directory[-2:],  tag, urlname)
		urllib.request.urlretrieve(urlname,  self.directory + "/" + tag  + '/' + each_image_id + 
		#                                '_' + Pitch    +
		#                                '_' + Roll     +
		...
		urlname = 'http://spectrumcatcher.polarstarspace.com/veggie/results/mkuriki/VeggieCamera_crops_device_' + each_image_id + ".json"
		print(self.directory[-2:],  tag, urlname)
		urllib.request.urlretrieve(urlname,  self.directory + "/" + tag  + '/' + each_image_id + 
		#                                '_' + Pitch    +
		#                                '_' + Roll     +
		...
		urlname = 'http://spectrumcatcher.polarstarspace.com/veggie/report/view_photo.php?id=mkuriki&pic_id=' + each_image_id
		print(self.directory[-2:],  tag, urlname)
		urllib.request.urlretrieve(urlname,  self.directory + "/" + tag  + '/' + each_image_id + 
		#                                '_' + Pitch    +
		#                                '_' + Roll     +
		...
		urlname = 'http://spectrumcatcher.polarstarspace.com/veggie/results/mkuriki/' + each_image_id + "_rotate.png"
		print(self.directory[-2:], tag, urlname)
		urllib.request.urlretrieve(urlname,  self.directory + "/" + tag  + '/' + each_image_id + 
		#                                '_' + Pitch    +
		#                                '_' + Roll     +
