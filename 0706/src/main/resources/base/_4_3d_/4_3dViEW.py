...
imgs = [os.path.join(subDir , 'cropped', s) for s in  os.listdir(os.path.join(subDir, 'cropped')) if ('_crop_1010.' in s)]
...
NDVI = np.load(os.path.join(subDir,'compiled','NDVI.npy'))
