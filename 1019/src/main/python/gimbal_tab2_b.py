...
class tab2b(QWidget):
	...
	def populate_grp1(self):
		...
		self.grp1 = QGroupBox("max min chooser")
		...
		self.grp1layout.addWidget(self.comboIndexGroup,		2,0,1,1)#, alignment=Qt.AlignTop)
		self.grp1layout.addWidget(self.comboColormap,		2,1,1,1)#, alignment=Qt.AlignTop)
		self.grp1layout.addWidget(self.seemore_aboutcmap,	2,2,1,1)
	...
	def populate_grp2(self):
		...
		self.grp2 = QGroupBox("Custom")
		self.grp2layout = QGridLayout()

		self.CustomEquation = QLineEdit()


		self.grp2layout.addWidget(QLabel("Custom equation"),0,0,1,1)
		self.grp2layout.addWidget(self.CustomEquation,      1,0,1,0)
